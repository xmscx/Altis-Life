/* 
	...
	Description:
	get all players from gang
	Parameters: gangid
*/
private["_sql","_query","_name","_atmCash","_gangPlayers","_group","_leaderid","_locked","_leadername"];

_query = "SELECT gangs.name, gangs.atmCash, gangs.leaderid, gangs.locked, players.name FROM gangs JOIN players on gangs.leaderid=players.playerid";
